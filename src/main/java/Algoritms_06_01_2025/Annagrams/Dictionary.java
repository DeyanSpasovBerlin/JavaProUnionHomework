...
//
//import Homework_08_11_2024.Task2.DescendingComparator;
//
//import java.util.*;
...
//    }
//
//    public Map<String,Integer> findRepetedWords(Map<String,Integer> map){
//        Map<String,Integer> repetedWords = new HashMap<>();
//        for (Map.Entry<String,Integer> entry  : map.entrySet()){
//            if(entry.getValue() > 1){
//                repetedWords.put(entry.getKey(),entry.getValue());
//            }
//        }
//        return repetedWords;
//    }
////    public Map<Integer,String[]> groupByFrequencyEntry(Map<String,Integer> map){
////        Map<Integer,String[]> groupingMap = new HashMap<>();
////        for (Map.Entry<String,Integer> entry  : map.entrySet()){
////            if(entry.getValue() > 1){
////                repetedWords.put(entry.getKey(),entry.getValue());
////            }
